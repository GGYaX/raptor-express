...
<?php
	...
	function wizard_save(){
		...
		if(isset($taxRate) && (!empty($taxRate) || $taxRate != '0')){
			...
			if(in_array($addressCountry,array(
				'country_Austria_14','country_Belgium_21','country_Bulgaria_33','country_Croatia_53','country_Cyprus_55','country_Czech_Republic_56',
				'country_Denmark_57','country_Estonia_67','country_Finland_72','country_France_73','country_Germany_81','country_Greece_84','country_Hungary_97',
				'country_Ireland_103','country_Italy_105','country_Latvia_117','country_Lithuania_123','country_Luxembourg_124','country_Malta_132',
				'country_Netherlands_150','country_Poland_170','country_Portugal_171','country_Romania_175','country_Slovakia_189','country_Slovenia_190',
				'country_Spain_195','country_Sweden_203','country_United_Kingdom_222'))){
