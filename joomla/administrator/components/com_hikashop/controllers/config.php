			...
			foreach($custom_fields as $custom_field){
				switch($custom_field->field_table){
					case 'contact':
						break;
					case 'item':
						if($custom_field->field_type=='customtext') break;
						$table = '#__hikashop_cart_product';
						if(!isset($structure[$table][$custom_field->field_namekey])) $structure[$table][$custom_field->field_namekey] = '`'.$custom_field->field_namekey.'` TEXT NULL';
						$table = '#__hikashop_order_product';
						if(!isset($structure[$table][$custom_field->field_namekey])) $structure[$table][$custom_field->field_namekey] = '`'.$custom_field->field_namekey.'` TEXT NULL';
						break;
					default:
						if(strpos($custom_field->field_table,'plg.')!==false) break;
						if($custom_field->field_type=='customtext') break;
