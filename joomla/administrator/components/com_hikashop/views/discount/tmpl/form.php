...
<?php } ?>
					<table class="admintable table" style="margin:auto">
						<tr>
							...
							<td>
								<?php echo JHTML::_('calendar', (@$this->element->discount_start?hikashop_getDate(@$this->element->discount_start,'%d %B %Y %H:%M'):''), 'data[discount][discount_start]','discount_start','%Y-%m-%d %H:%M',array('size'=>'20')); ?>
							</td>
						</tr>
						<tr>
							<td class="key">
							...
							<td>
								<?php echo JHTML::_('calendar', (@$this->element->discount_end?hikashop_getDate(@$this->element->discount_end,'%d %B %Y %H:%M'):''), 'data[discount][discount_end]','discount_end','%Y-%m-%d %H:%M',array('size'=>'20')); ?>
							</td>
						</tr>
<?php
	if(hikashop_level(1)){
