...
new window.oNamebox(
	\''.$id.'\',
	'.$this->getData($type, $root, $root == 0, $root == 0).',
	{mode:\'tree\',multiple:false,img_dir:\''.HIKASHOP_IMAGES.'\',map:\''.$map.'\'}
);
</script>';
		return $ret;
	}
...
new window.oNamebox(
	\''.$id.'\',
	'.$this->getData($type, $root, true).',
	{mode:\'tree\',multiple:true,img_dir:\''.HIKASHOP_IMAGES.'\',map:\''.$map.'\'}
);
</script>';
		return $ret;
	}
