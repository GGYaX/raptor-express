  ...
  <ul>
    ...
    <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
      ...
      <?php endif; ?>
			...
			<span class="moduleItemDateCreated"><i class="icon-calendar"></i><?php echo JHTML::_('date', $item->created, JText::_('VINA_K2_DATE')); ?></span>
		<?php endif; ?>
		...
		<?php if($params->get('itemHits')): ?>
			...
			<span class="moduleItemHits">
				...
				<?php echo $item->hits; ?> <?php echo JText::_('K2_TIMES'); ?>
			</span>
		<?php endif; ?>
