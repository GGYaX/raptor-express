			...
			<tr class="title">
				...
				<th class="first">
					<div class="jatable-cell-container">
						...
						<div class="actions">
							<span class="btn action btn-delete-col" data-action="delete_col" title="Delete Column"><i class="fa fa-minus"></i></span>
			...
			<tr class="first">
				...
				<td>
					<div class="actions">
						...
						<span class="btn action btn-delete-row" data-action="delete_row" title="Delete Row"><i class="fa fa-minus"></i></span>
					</div>
				</td>
			</tr>
		</tbody>
