	...
	<div class="itemAuthorLatest">
		...
		<ul>
			...
			<li class="<?php echo ($key%2) ? "odd" : "even"; ?>">
				<i class="icon-chevron-sign-right"><a href="<?php echo $item->link ?>"><?php echo $item->title; ?></a></i>
			</li>
			<?php endforeach; ?>
		</ul>
		<div class="clr"></div>
 ...
 <?php if($this->item->params->get('itemComments') && ($this->item->params->get('comments') == '1' || ($this->item->params->get('comments') == '2')) && empty($this->item->event->K2CommentsBlock)): ?>
  ...
  <?php endif; ?>
	...
	<div class="itemBackToTop">
		<a class="k2Anchor icon-circle-arrow-up" href="<?php echo $this->item->link; ?>#startOfPageId<?php echo JRequest::getInt('id'); ?>">
