...
if ($footerImg) {
    $footerBackgroundStyle = 'background-image: url("' . $footerImg .
...
<!-- BACK TOP TOP BUTTON -->
<div id="back-to-top-<?php echo $module->id; ?>" data-spy="affix"
	data-offset-top="300" class="back-to-top hidden-xs hidden-sm affix-top">
						...
						<div class="uber-social">
								...
								<?php if($helper->get('facebook')): ?>
									<a class="addthis_button_facebook_follow"
										addthis:userid="<?php echo $helper->get('facebook')?>"><i
										class="fa fa-facebook"></i></a>
								<?php endif; ?>

								<?php if($helper->get('google-plus')): ?>
								<a class="addthis_button_twitter_follow"
										addthis:userid="<?php echo $helper->get('google-plus')?>"><i
										class="fa fa-twitter"></i></a>
								<?php endif; ?>

								<?php if($helper->get('twitter')): ?>
								<a class="addthis_button_google_follow"
										addthis:userid="+<?php echo $helper->get('twitter')?>"><i
										class="fa fa-google-plus"></i></a>
								<?php endif; ?>

								<?php if($helper->get('pinterest')): ?>
								<a class="addthis_button_pinterest_follow"
										addthis:userid="+<?php echo $helper->get('pinterest')?>"><i
								...
								<a class="addthis_button_linkedin_follow"
										...
										addthis:userid="<?php echo $helper->get('linkedin')?>"><i
										class="fa fa-linkedin"></i></a>
								<?php endif; ?>
							</div>
								<script type="text/javascript"
									src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-52c4eb2a034cad83"></script>
								<!-- AddThis Follow END -->
							</div>
						<?php endif; ?>
						<div class="addthis_toolbox col-xs-6">
								<dl class="info-list">
									<dt>
										<i class="fa fa-home"></i> <span>营业时间</span>
									</dt>
									<dd>周一到周五：早10点-晚18点</dd>
									<dd>周六:早10点-晚17点</dd>
									<dd>周日:早9点-中午12点</dd>
									<dt>
										<i class="fa fa-home"></i> <span>地址</span>
									</dt>
									<dd>166 Boulevard de Stalingrad, 94200 Ivry Sur Seine</dd>
								</dl>
							</div>
							<div class="addthis_toolbox col-xs-6">
								<dl class="info-list">
									<dt>
										<i class="fa fa-phone"></i><span>联系电话</span>
									</dt>
									<dd>0650997649</dd>
									<dt>
										<i class="fa fa-weixin"></i><span>客服微信号</span>
									</dt>
									<dd>0650997649</dd>
									<dt>
										<i class="fa fa-qq"></i><span>客服QQ号</span>
									</dt>
									<dd>3088141264</dd>
									<dt>
										<i class="fa fa-envelope-o"></i><span>客服邮箱</span>
									</dt>
									<dd>zhongyousudi@gmail.com</dd>
								</dl>
							</div>
						</div>
					</div>
