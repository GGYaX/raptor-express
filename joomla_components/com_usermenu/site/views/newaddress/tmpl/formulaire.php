...
?>
<div class="container <?php echo (isset($collapse) && $collapse == true) ? 'collapse' : '' ; ?>" id="reDispAd">
	<div class="registration">
		<form action="<?php echo JURI::current() ?>?task=insert" method="post"
			...
			<fieldset>
				<div class="form-box">
					...
					<div class="row">
							...
							<div class="control-label">
								<span class="spacer"><span class="before"></span><span
									class="text"><label id="jform_spacer-lbl" class=""><strong
											class="red">*</strong> 必填字段</label></span><span class="after"></span></span>
							</div>
							<div class=""></div>
						</div>
						<div class="col-sm-6">
							<div class="control-label">
								<label id="jform_name-lbl" for="jform_name"
									...
									data-original-title="<strong>姓名：</strong><br />输入收件人/发件人全名"
									aria-invalid="true">姓名：<span class="star">&nbsp;*</span></label>
							</div>
							<div class="">
						...
						<div class="col-sm-6">
							<div class="control-label">
								<label id="jform_street-lbl" for="jform_street"
									class="hasTooltip required" title=""
									data-original-title="<strong>街道名字：</strong><br />输入街道名字"
									aria-invalid="true">街道名字：<span class="star">&nbsp;*</span></label>
							</div>
							<div class="">
						...
						<div class="col-sm-6">
							<div class="control-label">
								<label id="jform_city-lbl" for="jform_city"
									class="hasTooltip required" title=""
									data-original-title="<strong>城市：</strong><br />输入城市"
									aria-invalid="true">城市：<span class="star">&nbsp;*</span></label>
							</div>
							<div class="">
								<input type="text" name="jform[city]" id="jform_city" value=""
									class="required" size="30" required="required"
									aria-required="true" aria-invalid="true">
							</div>
						</div>
						<div class="col-sm-6">
							<div class="control-label">
								<label id="jform_state-lbl" for="jform_state" class="hasTooltip"
									title="" data-original-title="<strong>省份：</strong><br />输入省份"
									aria-invalid="true">省份：</label>
							</div>
							<div class="">
								<input type="text" name="jform[state]" id="jform_state" value=""
									class="" size="30" aria-required="true" aria-invalid="true">
							</div>
						</div>
						<div class="col-sm-6">
							<div class="control-label">
								<label id="jform_zip_code-lbl" for="jform_zip_code"
									class="hasTooltip required" title=""
									data-original-title="<strong>邮编：</strong><br />输入邮编"
									aria-invalid="true">邮编：<span class="star">&nbsp;*</span></label>
							</div>
							<div class="">
								<input type="text" name="jform[zip_code]" id="jform_zip_code"
									value="" class="required" size="30" required="required"
									aria-required="true" aria-invalid="true">
							</div>
						</div>
						<div class="col-sm-6">
							<div class="control-label">
								<label id="jform_country-lbl" for="jform_country"
									class="hasTooltip required" title=""
									data-original-title="<strong>国家：</strong><br />输入国家"
									aria-invalid="true">国家：<span class="star">&nbsp;*</span></label>
							</div>
							<div class="">
						...
						<div class="col-sm-6">
							<div class="control-label">
								<label id="jform_phone-lbl" for="jform_phone"
									class="hasTooltip required" title=""
									data-original-title="<strong>联系电话：</strong><br />输入联系电话"
									aria-invalid="true">联系电话：<span class="star">&nbsp;*</span></label>
							</div>
							<div class="">
			...
			<div class="form-actions">
				<button type="submit"
					class="btn btn-rounded btn-primary btn-lg smooth-scroll validate">添加地址</button>
			</div>
		</form>
	</div>
</div>